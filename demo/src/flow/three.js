...
declare module 'three' {
  declare type ArrayLike<T> = Array<T>;
  declare type AnimationActionLoopStyles = any;
  declare type Blending = any;
  declare type BlendingDstFactor = any;
  declare type BlendingEquation = any;
  declare type BlendingSrcFactor = any;
  declare type Colors = any;
  declare type Combine = any;
  declare type CullFace = any;
  declare type DepthModes = any;
  declare type FrontFaceDirection = any;
  declare type InterpolationModes = any;
  declare type Mapping = any;
  declare type PathActions = any;
  declare type PixelFormat = any;
  declare type Shading = any;
  declare type ShadowMapType = any;
  declare type Side = any;
  declare type TextureDataType = any;
  declare type TextureEncoding = any;
  declare type TextureFilter = any;
  declare type ToneMapping = any;
  declare type TrianglesDrawModes = any;
  declare type Wrapping = any;
  ...
  declare export class PropertyBinding {
    ...
    create(
      ...
      path: any,
      parsedPath?: any
    ): PropertyBinding | /* PropertyBinding.Composite */ $FlowFixMe;
  ...
  */
  declare export class InstancedBufferGeometry extends Object {}
  ...
  declare export class HemisphereLight extends Light {
    constructor(
      skyColorHex?: number | string,
      groundColorHex?: number | string,
      intensity?: number
    ): this;
    groundColor: Color;
    intensity: number;
  ...
  declare export class SpotLight extends Light {
    ...
    exponent: number;
    decay: number;
    shadow: /* SpotLightShadow */ $FlowFixMe;
    power: number;
    penumbra: number;
  }
